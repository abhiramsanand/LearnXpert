...
const AssessmentAverageScoreTrack: React.FC = () => {
  const [averageScore, setAverageScore] = useState<number>(0);
  const [loading, setLoading] = useState<boolean>(true);

  useEffect(() => {
    const cacheKey = "assessmentAverageScoreTrack";
    ...
    fetch(url)
      ...
      .then((data) => {
        const roundedScore = Math.round(data); // Round to nearest integer
...
export default AssessmentAverageScoreTrack;
